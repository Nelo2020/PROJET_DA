...
public class ApiDashboard {
    ...
    // Méthode pour obtenir le trimestre précédent
    private String getTrimestrePrecedent(String trimestre) {
        switch (trimestre) {
            case "Trimestre 2": return "Trimestre 1";
            case "Trimestre 3": return "Trimestre 2";
            case "Trimestre 4": return "Trimestre 3";
            default: return null; // Si le trimestre est le premier de l'année, il n'y a pas de trimestre précédent
        }
    }
    ...
    public Map<String, Object> getSumPrimeEmiseNetteAnnulationIARD(
