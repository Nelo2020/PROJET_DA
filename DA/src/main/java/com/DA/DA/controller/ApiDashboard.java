...
public class ApiDashboard {
    ...
    public ResponseEntity<List<String>> getNCAnneesVIE(){
        List<String> annees = noteConjonctureVIERepository.findListeNoteConjonturesAnnees();
        return ResponseEntity.ok().body(annees); 
    }
    @GetMapping("/IARD/annee")
    public ResponseEntity<List<String>> getNCAnneesIARD(){
        List<String> annees = noteConjonctureIARDRepository.findListeNoteConjonturesAnnees();
        return ResponseEntity.ok().body(annees); 
    }
    //New
    //Vue d'ensemble 
    ...
    //VIE Ensemble
    @GetMapping("/vieEnsemble/{annee}/{trimestre}")
    private Map<String, Double> getVieEnsemble(
            @PathVariable(value = "annee", required = false) String annee,
            @PathVariable(value = "trimestre", required = false) String trimestre) {
        Map<String, Double> vu_ensemble = new HashMap<>();
        ...
        if (annee != null && trimestre != null) {
            ...
            Long primeVie = noteConjonctureVIERepository.sumPrimeEmiseNetteAnnulationForTrimestre(annee, trimestre);
            Long primeAnneeprecedentVIE = noteConjonctureVIERepository.sumPrimeEmiseNetteAnnulationForTrimestre(String.valueOf(anneePrecedente), trimestre);
            Long comAnneeprecedentVIE = noteConjonctureVIERepository.sumCommissionCourtierForTrimestre(String.valueOf(anneePrecedente), trimestre);
            Long comVie = noteConjonctureVIERepository.sumCommissionCourtierForTrimestre(annee, trimestre);

            Long PrestationVieEPayesVie = noteConjonctureVIERepository.sumPrestationVieEffectivementPayesForTrimestre(annee, trimestre);
            Long PrestationVieEPayesAnneerecedentVIE= noteConjonctureVIERepository.sumPrestationVieEffectivementPayesForTrimestre(String.valueOf(anneePrecedente), trimestre);

            Long contratVie = noteConjonctureVIERepository.sumNombreContrat(annee, trimestre);
            Long contratAnneeprecedentVIE = noteConjonctureVIERepository.sumNombreContrat(String.valueOf(anneePrecedente), trimestre);

            Long effectifAnneeprecedentVIE = noteConjonctureVIERepository.sumEffectifPersonnelVie(String.valueOf(anneePrecedente), trimestre);
            ...
            vu_ensemble.put("primeVie", (primeVie != null ? primeVie.doubleValue() : 0.0));
            vu_ensemble.put("primeAnneeselectionneprecedentVIE", (primeAnneeprecedentVIE != null ? primeAnneeprecedentVIE.doubleValue() : 0.0));
            vu_ensemble.put("comVie", (comVie != null ? comVie.doubleValue() : 0.0));
            vu_ensemble.put("comAnneeprecedentVIE", (comAnneeprecedentVIE != null ? comAnneeprecedentVIE.doubleValue() : 0.0));
            vu_ensemble.put("PrestationVieEPayesVie", (PrestationVieEPayesVie != null ? PrestationVieEPayesVie.doubleValue() : 0.0));
            vu_ensemble.put("PrestationVieEPayesAnneerecedentVIE", (PrestationVieEPayesAnneerecedentVIE != null ? PrestationVieEPayesAnneerecedentVIE.doubleValue() : 0.0));
            vu_ensemble.put("contratVie", (contratVie != null ? contratVie.doubleValue() : 0.0));
            vu_ensemble.put("contratAnneeprecedentVIE", (contratAnneeprecedentVIE != null ? contratAnneeprecedentVIE.doubleValue() : 0.0));
            vu_ensemble.put("effectifVie", (effectifVie != null ? effectifVie.doubleValue() : 0.0));
            vu_ensemble.put("effectifAnneeprecedentVIE", (effectifAnneeprecedentVIE != null ? effectifAnneeprecedentVIE.doubleValue() : 0.0));
        } else {
            // Si l'année ou le trimestre est null, on renvoie des valeurs par défaut de 0
            vu_ensemble.put("primeVie", 0.0);
            vu_ensemble.put("primeAnneeselectionneprecedentVIE", 0.0);
            vu_ensemble.put("comVie", 0.0);
            vu_ensemble.put("comAnneeprecedentVIE", 0.0); 
            vu_ensemble.put("PrestationVieEPayesVie", 0.0);
            vu_ensemble.put("PrestationVieEPayesAnneerecedentVIE", 0.0);
            vu_ensemble.put("contratVie", 0.0);
            vu_ensemble.put("contratAnneeprecedentVIE", 0.0);
            vu_ensemble.put("effectifVie", 0.0);
            vu_ensemble.put("effectifAnneeprecedentVIE", 0.0);
        }

        return vu_ensemble;
    }
    //IARD Ensemble
    @GetMapping("/iardEnsemble/{annee}/{trimestre}")
    private Map<String, Double> getIADREnsemble(
            @PathVariable(value = "annee", required = false) String annee,
            @PathVariable(value = "trimestre", required = false) String trimestre) {
        Map<String, Double> vu_ensemble = new HashMap<>();
        ...
        if (annee != null && trimestre != null) {
            ...
            // Taux d'évolution prime émise nette d'annulation pour VIE
            Long primeIard = noteConjonctureIARDRepository.sumPrimeEmiseNetteAnnulationForTrimestre(annee, trimestre);
            Long primeAnneeprecedentIard = noteConjonctureIARDRepository.sumPrimeEmiseNetteAnnulationForTrimestre(String.valueOf(anneePrecedente), trimestre);
            Long comAnneeprecedentIard = noteConjonctureIARDRepository.sumCommissionCourtierForTrimestre(String.valueOf(anneePrecedente), trimestre);
            ...
            Long sinistrepayesAnneerecedentIard= noteConjonctureIARDRepository.sumSinistre_A_PayeesForTrimestre(String.valueOf(anneePrecedente), trimestre);

            Long contratIard = noteConjonctureIARDRepository.sumNombreContrat(annee, trimestre);
            Long contratAnneeprecedentIard = noteConjonctureIARDRepository.sumNombreContrat(String.valueOf(anneePrecedente), trimestre);

            Long effectifAnneeprecedentIard = noteConjonctureIARDRepository.sumEffectifPersonnelIard(String.valueOf(anneePrecedente), trimestre);
            Long effectifIard = noteConjonctureIARDRepository.sumEffectifPersonnelIard(annee, trimestre);

            // Ajout des valeurs calculées au dictionnaire
            vu_ensemble.put("primeIard", (primeIard != null ? primeIard.doubleValue() : 0.0));
            vu_ensemble.put("primeAnneeselectionneprecedentIard", (primeAnneeprecedentIard != null ? primeAnneeprecedentIard.doubleValue() : 0.0));
            vu_ensemble.put("comIard", (comIard != null ? comIard.doubleValue() : 0.0));
            vu_ensemble.put("comAnneeprecedentIard", (comAnneeprecedentIard != null ? comAnneeprecedentIard.doubleValue() : 0.0));
            vu_ensemble.put("sinistrepayesIard", (sinistrepayesIard != null ? sinistrepayesIard.doubleValue() : 0.0));
            vu_ensemble.put("sinistrepayesAnneerecedentIard", (sinistrepayesAnneerecedentIard != null ? sinistrepayesAnneerecedentIard.doubleValue() : 0.0));
            vu_ensemble.put("contratIard", (contratIard != null ? contratIard.doubleValue() : 0.0));
            vu_ensemble.put("contratAnneeprecedentIard", (contratAnneeprecedentIard != null ? contratAnneeprecedentIard.doubleValue() : 0.0));
            vu_ensemble.put("effectifIard", (effectifIard != null ? effectifIard.doubleValue() : 0.0));
            vu_ensemble.put("effectifAnneeprecedentIard", (effectifAnneeprecedentIard != null ? effectifAnneeprecedentIard.doubleValue() : 0.0));
        } else {
            // Si l'année ou le trimestre est null, on renvoie des valeurs par défaut de 0
            vu_ensemble.put("primeIard", 0.0);
            vu_ensemble.put("primeAnneeselectionneprecedentIard", 0.0);
            vu_ensemble.put("comIard", 0.0);
            vu_ensemble.put("comAnneeprecedentIard", 0.0); 
            vu_ensemble.put("sinistrepayesIard", 0.0);
            vu_ensemble.put("sinistrepayesAnneerecedentIard", 0.0);
            vu_ensemble.put("contratIard", 0.0);
            vu_ensemble.put("contratAnneeprecedentIard", 0.0);
            vu_ensemble.put("effectifIard", 0.0);
            vu_ensemble.put("effectifAnneeprecedentIard", 0.0);
        }
