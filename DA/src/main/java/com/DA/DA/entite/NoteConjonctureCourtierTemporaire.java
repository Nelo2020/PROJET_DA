...
@Data
@Entity
@Table(name = "NOTE_CONJONCTURE_COURTIER_TEMPORAIRE")
public class NoteConjonctureCourtierTemporaire implements Serializable {
    @Id
    ...
    public void onPrePersist() {
        setDateSoumission(new Date()); // Définit la date de soumission à la date courante lors de la création de l'entité
