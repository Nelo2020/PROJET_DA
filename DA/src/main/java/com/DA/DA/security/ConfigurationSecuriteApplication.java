...
//                                                .requestMatchers(PUT,"/api/DA/modifierMotDePasse/**").authenticated()
                                                ...
                                                .requestMatchers(GET,"/api/dashbord/IARD/annee").permitAll()
                                                .requestMatchers(GET,"/api/dashbord/vu_ensemble2/{annee}/{trimestre}**").permitAll()
                                                .requestMatchers(GET,"/api/dashbord/vieEnsemble/{annee}/{trimestre}**").permitAll()
                                                .requestMatchers(GET,"/api/dashbord/iardEnsemble/{annee}/{trimestre}**").permitAll()
